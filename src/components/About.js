        ...
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1
            className={`title-font sm:text-4xl text-3xl mb-4 font-medium ${
              props.colorTheme.cond ? "text-white" : "text-black"
            }`}
          >
            Hi, I'm Yoniber.
          ...
          <p
            className={`mb-8 leading-relaxed  ${
              props.colorTheme.cond ? "" : "text-gray-900"
            }`}
          >
            Software Developer, using ASP.NET for the backend and react js for
            the front-end trying to apply the best practices using clean code
            and solid Principles for development.
          </p>
          <div className="flex justify-center">
            <a
              ...
              className={`inline-flex ${
                props.colorTheme.cond ? "text-white" : "text-black"
              } bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg`}
            >
              Work With Me
            </a>
            <a
              ...
              className={`ml-4 inline-flex ${
                props.colorTheme.cond
                  ? "text-gray-400 bg-gray-800 hover:bg-gray-700 hover:text-white"
                  : "text-gray-900 bg-gray-400 hover:bg-gray-300 hover:text-black"
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <img
            ...
            src={
              ...
              "/images/tecnologys/" +
              (props.colorTheme.cond ? "sqlserver.svg" : "sqlserverblack.svg")
            }
          />
